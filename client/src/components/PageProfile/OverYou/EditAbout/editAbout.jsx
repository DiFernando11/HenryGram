...
function EditAbout({ editAbout, setEditAbout, userId, currentAbout}) {
  ...
  return (
    <form onSubmit={ handleSubmit } className="h-full">
      <div className="w-full h-full flex flex-col justify-between   rounded-lg  dark:bg-gray-700 dark:border-gray-600">
        <div className=" bg-transparent rounded-t-lg dark:bg-gray-800">
          ...
          <textarea
            id="comment"
            rows="4"
            className="w-full h-full px-0 text-sm text-realBlack bg-transparent border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
