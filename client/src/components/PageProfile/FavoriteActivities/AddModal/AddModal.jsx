	...
	return (
		<form className="fixed bg-black z-50 inset-x-0 inset-y-0 m-auto w-2/5 h-fit p-5 flex flex-col gap-4">
			...
			<div className="flex flex-col gap-3">
				...
				<input
					type="text"
					className="bg-gray-700 border-none transition-all duration:100 focus:border-none rounded-full h-fit w-full p-2"
			...
			<div className="flex flex-col gap-3">
				...
				<input
					type="text"
					className="bg-gray700 border-none focus:border-none rounded-full h-fit w-full p-2"
