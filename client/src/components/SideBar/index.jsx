...
function SideBar() {
	...
	return (
		<aside className="w-64 bg-yellower relative font-sans" aria-label="Sidebar">
			<div className="overflow-y-auto bg-yellower py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
				<ul className="space-y-2">
					<a href="https://flowbite.com/" class="flex items-center pl-2.5 mb-5">
						<img
							src="https://flowbite.com/docs/images/logo.svg"
							class="mr-3 h-6 sm:h-7 text-black"
							alt="Flowbite Logo"
						/>
						<span class="self-center text-xl font-semibold text-black whitespace-nowrap dark:text-white">
							Logo
						</span>
					</a>
					<ul className='flex flex-col -center'>
						{routes.map((route) => {
							...
							return (
								<li>
									<NavLink
										to={route.to}
										className="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg transition duration:200 dark:text-white hover:bg-yellow dark:hover:bg-gray-700"
									>
