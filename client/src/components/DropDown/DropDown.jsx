			...
			<Menu as="div" className="relative inline-block text-left  ">
				<div>
					<Menu.Button
						...
						className={`inline-flex ${ friendRequests.length ? "ml-5" : ''} z-10 w-56  flex items-center justify-center drop-shadow-md rounded-md bg-transparent bg-opacity-20 px-4 py-2 font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 ml-1 text_sombra text-lg`}
					>
						FRIEND REQUEST
						{friendRequests.length ? <h2 className='ml-3 bg-danger flex items-center justify-center rounded-full w-6 h-6'>{friendRequests.length}</h2> : null}
					</Menu.Button>
				</div>
				<Transition
					as={Fragment}
