      ...
      <Menu as="div" className="relative inline-block text-left  ">
        <div>
          <Menu.Button
            ...
            className="inline-flex z-10 justify-center w-56 drop-shadow-md rounded-md bg-transparent bg-opacity-20 px-4 py-2 font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 ml-1 text_sombra text-lg"
          >
            FRIEND REQUEST
          </Menu.Button>
        </div>
